            ...
            <div className="space-y-3">
                  ...
                  <div className="mt-1 grid md:grid-cols-3 gap-2 text-[11px] text-slate-700">
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        ...
                        <span className="text-slate-500">(выписки, анализы)</span>
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span
                      ...
                      <span>
                        ...
                        <span className="text-slate-500">(от вашего имени)</span>
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span
              ...
              {trusted.length === 0 && (
                <p className="text-[13px] text-slate-500">
                  Доверенных лиц пока нет. Вы можете добавить их с помощью
                  кнопки выше. Это удобно, если, например, за питомцем ухаживают
