      ...
      <main className="flex-1 bg-slate-50/70 py-8">
        <div className="container mx-auto max-w-5xl px-4">
          ...
          >
            ...
            {/* ДАЛЬШЕ — полностью тот же код формы, что у тебя был:
                Контактные данные, Питомец, Кратко о проблеме,
                Услуга/Врач/Время/Файлы, Вы выбрали, Согласия.
                Я его не меняю, чтобы не раздувать ответ — можно просто
                оставить как есть из твоего последнего рабочего файла. */}
            {/* ... здесь вставляешь всю остальную часть формы без изменений ... */}
          </form>
        </div>
      </main>
      <Footer />
